...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/template/LineIcons.2.0.css') }}">
    <link rel="stylesheet" href="{{ asset('css/template/tailwind.css') }}">
</head>
<body>
    ...
    <header class="header-area">
        ...
        <div id="home" class="header-hero" style="background-image: url({{ asset('img/template/banner-bg.svg') }})">
            <div class="container">
                ...
                <div class="justify-center row">
                    <div class="w-full lg:w-2/3">
                        <div class="text-center header-hero-image wow fadeIn" data-wow-duration="1.3s"
                            data-wow-delay="1.4s">
                            <img src="{{ asset('img/template/header-hero.png') }}" alt="hero">
                ...
                <div class="w-full sm:w-2/3 lg:w-1/3">
                    <div class="single-services wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="mt-8 services-content">
                            ...
                            <p class="mb-8">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod
    ...
    <footer id="footer" class="relative z-10 footer-area pt-120">
        <div class="footer-bg" style="background-image: url({{ asset('img/template/footer-bg.svg') }});"></div>
        <div class="container">
...
-->
    ...
    <script src="{{ asset('js/template/vendor/jquery-3.5.1-min.js') }}"></>
    <script src="{{ asset('js/template/vendor/modernizr-3.7.1.min.js') }}"></script>
    ...
    <script src="{{ asset('js/template/scrolling-nav.js') }}"></script>
    <script src="{{ asset('js/template/wow.min.js') }}"></script>
    <script src="{{ asset('js/template/particles.min.js') }}"></script>
